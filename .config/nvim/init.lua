...
--vim.opt.wildmode = "list:longset,full"
...
vim.keymap.set('n', '[q', "<cmd>cprev<cr>", { desc = 'Go to previous [Q]uickfix error' })
vim.keymap.set('n', ']q', "<cmd>cnext<cr>", { desc = 'Go to next [Q]uickfix error' })
